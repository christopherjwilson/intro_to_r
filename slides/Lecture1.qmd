...
-   Two of the most important (but sometimes neglected) aspects of the thesis project are the **rationale and the research question**.
...
However, there can be a perception that "clinically relevant" research is research the has a clinical sample.

This is only a section of clinically-relevant research.

If we focus on the research that is designed to look at the causes of, or find explanations for clinical pathologies, we can subdivide that into several types...
...
Comer and Kednall outline 4 types of clinical research and explain what can and cannot be understood through each of them.

The key here is to recognise that the inclusion of a clinical sample allows us to answer certain questions, actually but stops us from answering others
...
-   Type II might to gain a deeper understanding of the processes or experiences.
...
# Linking basic research to clinical interventions {background-image="https://www.tees.ac.uk/Images/CommonImages/prospectus/course_images/main/psychology.jpg" background-color="black"}
...
2.  *How* do we modify interventions to change this target?
...
-   Try to *focus* your research questions on specific mechanisms or variables that are theoretically relevant, as opposed to being overly broad in your approach.
...
## How to make your research reproducible? {.smaller}
