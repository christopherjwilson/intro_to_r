...
```{=html}
<iframe width="1200" height="700" src="https://lindeloev.github.io/tests-as-linear/linear_tests_cheat_sheet.pdf" title="Webpage example"></iframe>
```
...
-   The null hypothesis is that the line of best fit is no better at predicting the y variable than the mean of the y variable
